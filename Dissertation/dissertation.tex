...
\linebreak
\textit{Note on the division into prototypes: As specified in the preparation chapter, a primitive prototype was implemented early on in the development of the system. This chapter presents the final version without discriminating between different prototypes. For a description of the differences between the prototypes see section !! of the evaluation chapter.}   
\subsection{Libraries}
