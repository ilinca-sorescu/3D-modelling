...
\begin{figure}
\begin{center}
\includegraphics[scale=0.67]{figs/minRatio0.png}	
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.67]{figs/volumeByMinRatio.png}	
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.67]{figs/minRatio004-1.png}	
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.67]{figs/time.png}	
\caption{The execution time as a function of the number of input images.}
\end{center}
\end{figure}
\begin{figure}
\begin{center}
\includegraphics[scale=0.67]{figs/numVertices.png}	
...
Due to multiple sections being developed simultaneously, continuous integration was essential in order to avoid the creation of an "integration hell" during the implementation of the point cloud constructor. At every stage, the whole system was reevaluated and tested to ensure that all sections were running in concert to achieve the desired effect.
