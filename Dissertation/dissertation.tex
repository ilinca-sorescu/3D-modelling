...
\begin{itemize}
\item \textbf{detect features:} In each of the two images, find the  
\item \textbf{extract feature descriptors:}
...
\section{Summary}
This chapter provides a description of what was the intended outcome of this project and of the choices made prior to implementation in order to ensure its successful completion. 
