...
\caption{Results in the field of 3D reconstruction. The digital models of chickens are obtained using the web-based tool ARC3D. These models were constructed as part of the iMinds INSTANCE project.\protect\footnotemark}
\end{figure}
\footnotetext{The image can be found at \url{http://homes.esat.kuleuven.be/~konijn/3d/}. I have been given permission to use this image.}
...
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.37]{figs/input-r.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.37]{figs/meshlab-r.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.37]{figs/qhull-r.png}}
...
\footnotetext{created using POV-Ray and the model found at \url{http://objects.povworld.org/objects/cgi-bin/dl.cgi?scrmbl.zip}.}



The generation of a surface from a list of points is an active research topic. Consequently, devising an algorithm for doing so was not feasible within the given time. If the input object is known to be convex, however, the task becomes purely deterministic; in this case the wanted polygon mesh is equal to the convex hull of the resulting point cloud.\\
\linebreak
...
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.13]{figs/1.png}}
\end{minipage}%
\begin{minipage}{.25\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.13]{figs/2.png}}
\end{minipage}%\par\medskip
\begin{minipage}{.25\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.13]{figs/3.png}}
\end{minipage}%
\begin{minipage}{.25\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.13]{figs/4.png}}
\end{minipage}\par\medskip
...
\linebreak
The surface reconstruction technique used to generate the images presented in Figure 4.1 imposes harsh restrictions on the shape of the input object. Nonetheless, the point cloud is found to emulate the input model outside of these restrictions, for example for input objects containing sharp concavities or round surfaces. Figures 4.2 and 4.3 are evidence of this fact.
\begin{figure}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.3]{figs/spider-i.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.3]{figs/spider.png}}
\end{minipage}\par\medskip
\caption{Results: input image and resulting point cloud.\protect\footnotemark}
\label{fig:main}
\end{figure}

\footnotetext{The input model can be found at \url{http://objects.povworld.org/cgi-bin/dl.cgi?beast.zip}.}

\begin{figure}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.3]{figs/teapot-i.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.3]{figs/teapot.png}}
\end{minipage}\par\medskip
\caption{Results: input image and resulting point cloud.\protect\footnotemark}
\label{fig:main}
\end{figure}
...
\footnotetext{The input model can be found at \url{http://cmp.felk.cvut.cz/data/povray/scenes/level3/teapot/}.}
