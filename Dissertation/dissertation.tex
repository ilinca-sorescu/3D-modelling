...
\chapter{Preparation}
In the project proposal I gave a broad outline of the work that needs to be done in order to accomplish the goals of this project. The purpose of this chapter is to fill in those details and to provide the theoretical background for understanding some of the techniques and algorithms involved in the development of this project.
